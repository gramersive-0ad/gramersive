...
declare namespace Helpers
{
	class Resources extends GlobalScripts.Resources
	{
		 ...
		 */
		BuildSchema(datatype: string, additional?: any[], subtypes?: boolean): string;
 ...
 */
declare function QueryOwnerInterface(ent: number, iid?: number): Simulation.Component;
...
declare namespace Components
{
	 ...
	 */
	type NotificationType = "aichat" | "defeat" | "won" | "diplomacy" | "ceasefire-ended" |
		"tutorial" | "tribute" | "barter" | "spy-response" | "attack" | "phase" | "dialog" |
		"playercommand" | "play-tracks" | "map-flare";
	...
	class Health extends Simulation.Component
	{
		 ...
		 */
		TakeDamage(amount: number, attacker: number, attackerOwner: number): HealthChange;
	...
	class Timer extends Simulation.Component
	{
		 ...
		 */
		SetTimeout(ent: number, iid: number, funcname: string, time: number, data: any): number;
		 ...
		 */
		SetInterval(ent: number, iid: number, funcname: string, time: number, repeattime: number, data: any): number;
